...
export const verifyTelegramWebAppData = (bot_token: string, telegramInitData: string): boolean => {
...
console.log(verifyTelegramWebAppData(VALID_BOT_TOKEN, VALID_INIT_DATA));
